...
export default function OwnerPayments() {
  ...
  const fetchPayments = async () => {
    try {
      ...
      const paymentsRes = await fetch(`/api/owner-payments-list?owner_id=${owner_id}${statusParam}`);
      ...
      if (paymentsData.success) {
        ...
        const formattedPayments = paymentsData.payments.map((payment) => ({
          ...
          image: payment.product_image || "/pictures/product-img-placeholder/placeholder.png",
          ...
          rentalStartDate: new Date(payment.start_date).toLocaleDateString("en-US", {
            year: "numeric",
            month: "short",
            day: "numeric",
          }),
          rentalEndDate: new Date(payment.end_date).toLocaleDateString("en-US", {
            year: "numeric",
            month: "short",
            day: "numeric",
          }),
