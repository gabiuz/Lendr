    ...
    <div className="bg-white min-h-screen w-full">
      <nav className="bg-white flex justify-between shadow-md">
            <Image
              ...
              height={54}
              alt="blendr logo"
              className="w-30 xl:w-32 px-3 py-3"
            />
      </nav>
      <div className="text-black flex justify-between px-4 py-8">
...
<p>Edit Profile</p>
      ...
      <Image src="/pictures/sample-profile-photo.jpg" alt="profile photo" height={300} width={300} className="rounded-4xl"></Image>
      </div>
      <div className="Name-container flex flex-col gap-4 mb-4 mt-6 mx-4">
{formFields.name.map((field) => (
                ...
                <div className="radio-container w-full px-4 lg:mr-8">
                  <label className="text-black mb-1.5 block">
                    Sex<span className="text-red">*</span>
                  </label>
                  <div className="flex w-full gap-3 justify-around lg:w-fit">
                ...
                <div className="emailAndPhoneAndAddress-container flex flex-col gap-4 mb-4 mt-6 mx-4">
                  {formFields.emailAndPhoneAndAddress.map((field) => (
                  <Input
                    key={field.id}
                    label={field.label}
                    type="text"
                ...
                <div className="button-container flex flex-col justify-between gap-3 px-4 pb-6 lg:justify-end">
                <Button
                  label="Cancel"
